...
run_id <- paste0("#",SYS_INPUT_FRACTION_SEED,"#",SYS_INPUT_DATA_FRACTION,"#",SYS_MODEL_ID,"#",Sys.time())
ma_model_id <- paste0("MA_",run_id)
...
opt_model_id <- paste0("MODEL_",run_id)
save(me_classification_model, file = paste0(opt_model_id,".rda"))
